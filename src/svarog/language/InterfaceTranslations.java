...
public class InterfaceTranslations {
  ...
  ArrayList<InterfaceTranslation> data = new ArrayList<InterfaceTranslation>();
  ...
  void SetNewInterfaceTranslations(languages option){
      Destroy();
      CreateData(Options(option));
  }
  ...
  String Options(languages option){
      String file_name;
